...
public class AddstaffDetails extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_staff_details);
        ...
        b11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    String q1="CREATE TABLE staffinfo(staffid TEXT PRIMARY KEY,name TEXT,gender TEXT,day INTEGER,month INTEGER,year INTEGER,phone TEXT,classs TEXT,address TEXT,password TEXT,dept TEXT);";
                    db.execSQL(q1);
                }
                catch (Exception e)
                {
                ...
                String insert="INSERT INTO staffinfo(staffid,name,gender,day,month,year,phone,classs,address,password,dept) VALUES('"+e1.getText().toString()+"','"+ e2.getText().toString()+"','"+t1+"','"+xday+"','"+xmonth+"','"+xyr+"','"+e4.getText().toString()+"','"+classs+"','"+e6.getText().toString()+"','"+rn+"','"+t2+"')";
                try{
                    mydb.execSQL(insert);
                    Toast.makeText(getApplicationContext(),"staff Details Entry success ",Toast.LENGTH_SHORT).show();


                    Intent i=new Intent(AddstaffDetails .this,Adminpage.class);
